...
def test_delete_schedule_success(test_engine, sample_schedule):
    """일정 삭제 성공 테스트"""
...
def test_create_schedule_utc_conversion_kst(test_session):
...
def test_create_schedule_utc_conversion_est(test_session):
...
def test_create_schedule_utc_conversion_naive(test_session):
...
def test_update_schedule_utc_conversion_kst(test_session, sample_schedule):
...
def test_utc_conversion_preserves_time_value(test_session):
